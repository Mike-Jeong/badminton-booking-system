...
export const dictionary = {
  ko: {
    ...
    list: {
      ...
      emptyFiltered: "선택한 기간에 해당하는 예약일이 없습니다.",
      time: "시간",
      location: "장소",
      duty: "듀티",
      slots: "슬롯",
    ...
    lookup: {
      ...
      payment: "결제확인",
      paymentExempt: "면제",
      paymentUnconfirmed: "미확인",
      paymentAwaitingConfirmation: "확인 대기",
      paymentConfirmed: "확인됨",
      paymentUpload: "증빙 업로드",
  ...
  en: {
    ...
    list: {
      ...
      emptyFiltered: "No booking days match the selected date range.",
      time: "Time",
      location: "Location",
      duty: "Duty",
      slots: "Slots",
    ...
    lookup: {
      ...
      paymentAwaitingConfirmation: "Awaiting confirmation",
      paymentConfirmed: "Confirmed",
      paymentUpload: "Upload proof",
...
const KNOWN_ERROR_MESSAGES: Record<string, string> = {
  ...
  "file이 필요합니다.": "A file is required.",
  "전화번호가 일치하지 않아 업로드할 수 없습니다.": "Cannot upload — phone number does not match.",
  "취소된 예약에는 결제 증빙을 업로드할 수 없습니다.": "Cannot upload proof for a cancelled booking.",
  "이미지 파일(jpeg/png/webp)만 업로드할 수 있습니다.": "Only image files (jpeg/png/webp) can be uploaded.",
  "파일 크기는 2MB를 초과할 수 없습니다.": "File size cannot exceed 2MB.",
  "multipart/form-data 요청이 필요합니다.": "A multipart/form-data request is required.",
};
